...
## 1. Understand — what SysBot is and how it works

| Guide | Read it to… |
|---|---|
| [README](../README.md) | Get the 2-minute pitch: what SysBot does, quick start, feature list |
...
| [Models](models.md) | Pick a local model for your hardware, manage it with Ollama, point SysBot at it |

## 3. Use — day-to-day

| Guide | Read it to… |
|---|---|
| [Using SysBot](usage.md) | Chat vs. slash commands, passing arguments, confirmations, history, managing tools, common issues |
...
| [Configuration](configuration.md) | Every setting: `config.yaml` reference, `SYSBOT_*` env vars, CLI flags |
...
| [Building a Windows .exe](building-windows-exe.md) | Ship a standalone `sysbot.exe` to users with no Python |

## 6. Contribute — improve SysBot itself
...
- *"Something's wrong"* → [Using SysBot §11 Common issues](usage.md#11-common-issues), then `logs/traces.jsonl` ([format](configuration.md#6-traces-log-format)).
